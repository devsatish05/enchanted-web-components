...
import { DEFAULT_CALENDAR_LOCALE } from '../types/dx-datepicker';

const meta: Meta = {
  title: 'Input/dx-datepicker',
  component: 'dx-datepicker',
  tags: ['autodocs'],
  argTypes: {
    name: {
      control: { type: 'text' },
...
export const DxDatepicker: Story = {
  render: (args) => {
    return html`
      <dx-datepicker
        .name=${args.name}
      ...
      <div style="display: flex; flex-direction: column; gap: 40px; padding: 20px;">
        <div>
          ...
          <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            <dx-datepicker .label=${'Default Datepicker'} .name=${'datepicker-1'}></dx-datepicker>
            <dx-datepicker .label=${'With Selected Date'} .name=${'datepicker-2'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'Required Field'} .name=${'datepicker-3'} ?requiredField=${true}></dx-datepicker>
            <dx-datepicker .label=${'With Remove Button'} .name=${'datepicker-4'} .value=${selectedDate} ?showRemoveLabel=${true}></dx-datepicker>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            <dx-datepicker .label=${'With Input Action'} .name=${'datepicker-5'} ?showInputAction=${true}></dx-datepicker>
            <dx-datepicker .label=${'Hidden Helper Text'} .name=${'datepicker-6'} ?hideHelperText=${true}></dx-datepicker>
            <dx-datepicker .label=${'With Tooltip'} .name=${'datepicker-7'} .helperIconTooltip=${'This is a helpful tooltip message'}></dx-datepicker>
            <dx-datepicker .label=${'Custom Field ID'} .name=${'datepicker-8'} .field=${'custom-field-id'}></dx-datepicker>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            <dx-datepicker .label=${'Disabled Empty'} .name=${'datepicker-9'} ?disabled=${true}></dx-datepicker>
            <dx-datepicker .label=${'Disabled with Date'} .name=${'datepicker-10'} .value=${selectedDate} ?disabled=${true}></dx-datepicker>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
            <dx-datepicker .label=${'English (en)'} .name=${'datepicker-11'} .locale=${'en'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'French (fr)'} .name=${'datepicker-12'} .locale=${'fr'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'German (de)'} .name=${'datepicker-13'} .locale=${'de'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'Spanish (es)'} .name=${'datepicker-14'} .locale=${'es'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'Italian (it)'} .name=${'datepicker-15'} .locale=${'it'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'Chinese (zh)'} .name=${'datepicker-16'} .locale=${'zh'} .value=${selectedDate}></dx-datepicker>
            <dx-datepicker .label=${'Japanese (ja)'} .name=${'datepicker-17'} .locale=${'ja'} .value=${selectedDate}></dx-datepicker>
          </div>
        </div>
